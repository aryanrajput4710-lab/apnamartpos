...
with open('src/controllers/reportController.js', 'r') as f:
    code = f.read()
...
final_payload_find = "summary: { revenue, profit, orders: ordersCount, itemsSold, aov, tax, discounts }"
final_payload_replace = "summary: { revenue, profit, orders: ordersCount, itemsSold, aov, tax, discounts, prevRevenue, prevProfit, prevOrders: prevOrdersCount, prevItemsSold, prevAov }"
code = code.replace(final_payload_find, final_payload_replace)

with open('src/controllers/reportController.js', 'w') as f:
    f.write(code)
